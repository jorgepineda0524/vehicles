...
namespace Vehicles.Api.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckUserAsync("1020", "Luis","Salazar","luiss@gmail.com","3024170164", "Carrera 46", UserType.Admin);
            await CheckUserAsync("1010", "Jorge","Pineda","jorge@gmail.com","3024170164", "Carrera 46", UserType.User);
            await CheckUserAsync("1030", "Ana","Mena","ana@gmail.com","3024170164", "Carrera 46", UserType.User);
        }
        ...
        private async Task CheckBrandAsync()
        {
            if (!_context.Brands.Any())
            {
                ...
                _context.Brands.Add(new Brand { Description = "Mercedez Benz" });
                _context.Brands.Add(new Brand { Description = "Zuzuki" });
                ...
                _context.Brands.Add(new Brand { Description = "Royal Enfield" });
